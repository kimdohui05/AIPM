    ...
    <div className={styles.container}>
      ...
      <section className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>
          복잡한 프로젝트 관리<br />
          <span className={styles.heroHighlight}>이제 UNIP에게</span> 맡기세요
        </h1>
      ...
      <section className={styles.features}>
        <h2 className={styles.featuresTitle}>UNIP이 해드리는 것들</h2>
      ...
      <section className={styles.cta}>
        <div className={styles.ctaBox}>
          <h2>지금 바로 시작해보세요</h2>
          <p>UNIP과 함께라면 복잡한 프로젝트 관리도 쉬워집니다</p>
          <p
            onClick={() => navigate('/login')}
            style={{ marginTop: '12px', fontSize: '13px', color: '#3BBFD4', cursor: 'pointer', textDecoration: 'underline' }}
          >
            누르면 로그인 페이지로 이동합니다
          </p>
        </div>
      ...
      <footer className={styles.footer}>
        ...
        <p>© 2026 UNIP. All rights reserved.</p>
      </footer>
