    ...
    <div className={styles.container}>
      ...
      <section className={styles.features}>
        ...
        <div className={styles.featureGrid}>
          {[
            { icon: '✅', title: '태스크 자동 생성', desc: '프로젝트 정보를 입력하면 AI가 태스크를 자동으로 생성하고 팀원에게 배정합니다.' },
            { icon: '📊', title: '진행 상황 분석', desc: '팀원이 남긴 로그를 AI가 읽고 실시간으로 피드백과 코멘트를 제공합니다.' },
            { icon: '⚠️', title: '리스크 감지', desc: '일정 지연 가능성과 병목 구간을 자동으로 감지하고 알려드립니다.' },
            { icon: '📋', title: '보고서 자동 생성', desc: '주간 보고서와 프로젝트 현황을 버튼 하나로 자동 생성합니다.' },
